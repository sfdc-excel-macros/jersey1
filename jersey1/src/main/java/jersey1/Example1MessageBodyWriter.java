...
@Provider
@Produces("text/html")
public class Example1MessageBodyWriter implements MessageBodyWriter<Example1> {
    ...
    @Override
    public long getSize(Example1 myBool, Class type, Type genericType,
    ...
    @Override
    public void writeTo(Example1 myBool,
                        Class type,
                        Type genericType,
